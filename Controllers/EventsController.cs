...
namespace ZenithWebSite.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventId,EventFromDatetime,EventToDatetime,IsActive,ActivityId")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,EventFromDatetime,EventToDatetime,CreationUsername,CreationDate,IsActive,ActivityId")] Event @event)
        {
            if (ModelState.IsValid)
            {
